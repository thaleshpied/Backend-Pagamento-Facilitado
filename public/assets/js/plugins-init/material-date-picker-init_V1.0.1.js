(function($) {
    ...
    $('#timepicker6').bootstrapMaterialDatePicker({
        format: 'HH:mm',
        time: true,
        date: false
    });
    $('#timepicker7').bootstrapMaterialDatePicker({
        format: 'HH:mm',
        time: true,
        date: false
    });
    $('#timepicker8').bootstrapMaterialDatePicker({
        format: 'HH:mm',
        time: true,
        date: false
    });
    $('#horaliberacaoandaime').bootstrapMaterialDatePicker({
        format: 'HH:mm',
        time: true,
        date: false
    });
    $('#timepicker9').bootstrapMaterialDatePicker({
        format: 'HH:mm',
        time: true,
        date: false
    });
